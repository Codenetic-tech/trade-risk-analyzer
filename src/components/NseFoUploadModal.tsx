...
interface NseFoUploadModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onFilesSelected: (files: { risk: File | null; nse: File | null; cc01: File | null; }) => void;
}

export const NseFoUploadModal: React.FC<NseFoUploadModalProps> = ({
  open,
  onOpenChange,
  onFilesSelected,
}) => {
            ...
            <CardContent>
              {riskFile ? (
                ...
                <div className="text-center py-8">
                  ...
                  <label htmlFor="risk-upload-modal-fo" className="cursor-pointer">
                    <span className="text-blue-600 hover:text-blue-700 font-medium">
                      Click to upload
                    </span>
                  </label>
                  <input
                    id="risk-upload-modal-fo"
                    type="file"
                    accept=".xlsx,.xls"
                    className="hidden"
                    onChange={(e) => {
          ...
          <Card className="border-2 border-dashed border-slate-300 hover:border-blue-400 transition-colors">
            ...
            <CardContent>
              {nseFile ? (
                ...
                <div className="text-center py-8">
                  <Upload className="mx-auto h-12 w-12 text-slate-400 mb-4" />
                  <label htmlFor="nse-upload-modal-fo" className="cursor-pointer">
                    <span className="text-blue-600 hover:text-blue-700 font-medium">
                      Click to upload
                    </span>
                  </label>
                  <input
                    id="nse-upload-modal-fo"
                    type="file"
                    accept=".csv"
                    className="hidden"
                    onChange={(e) => {
          ...
          <Card className="border-2 border-dashed border-slate-300 hover:border-blue-400 transition-colors">
            ...
            <CardContent>
              {cc01File ? (
                ...
                <div className="text-center py-8">
                  <Upload className="mx-auto h-12 w-12 text-slate-400 mb-4" />
                  <label htmlFor="cc01-upload-modal-fo" className="cursor-pointer">
                    <span className="text-blue-600 hover:text-blue-700 font-medium">
                      Click to upload
                    </span>
                  </label>
                  <input
                    id="cc01-upload-modal-fo"
                    type="file"
                    accept=".csv"
                    className="hidden"
                    onChange={(e) => {
